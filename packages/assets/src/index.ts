...
export const SVG = {
  ...
  tabbar_home_active_25: require('./svg/tabbar/home-active-25.svg').default?.src || require('./svg/tabbar/home-active-25.svg'),
  tabbar_activity_25: require('./svg/tabbar/activity-25.svg').default?.src || require('./svg/tabbar/activity-25.svg'),
  ...
  tabbar_deposit_25: require('./svg/tabbar/deposit-25.svg').default?.src || require('./svg/tabbar/deposit-25.svg'),
  tabbar_deposit_active_25: require('./svg/tabbar/deposit-active-25.svg').default?.src || require('./svg/tabbar/deposit-active-25.svg'),
  tabbar_profile_25: require('./svg/tabbar/profile-25.svg').default?.src || require('./svg/tabbar/profile-25.svg'),
  tabbar_profile_active_25: require('./svg/tabbar/profile-active-25.svg').default?.src || require('./svg/tabbar/profile-active-25.svg'),
  tabbar_bg_flexible_25: require('./svg/tabbar/bg-flexible-25.svg').default?.src || require('./svg/tabbar/bg-flexible-25.svg'),
